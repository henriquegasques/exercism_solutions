...
var $author$project$CollatzConjecture$runStep = F2(
	function (num, count) {
		runStep:
		while (true) {
			if (num === 1) {
				...
				if (!A2($elm$core$Basics$modBy, 2, num)) {
...
var $author$project$CollatzConjecture$collatz = function (start) {
	return (start <= 0) ? $elm$core$Result$Err('Only positive integers are allowed') : A2($author$project$CollatzConjecture$runStep, start, 0);
};
	...
	_List_fromArray(
		[
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Result$Err('Only positive integers are allowed'),
...
var pipeFilename = "/tmp/elm_test-1184521.sock";
var net = require('net'),
