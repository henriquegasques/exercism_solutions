	...
	function (func, input) {
		if (!input.b) {
			...
			return A2(
				$elm$core$List$cons,
				func(x),
				A2($author$project$Accumulate$accumulate, func, xs));
		}
	});
...
var $author$project$Test$Generated$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$Tests$square),
...
var pipeFilename = "/tmp/elm_test-738694.sock";
var net = require('net'),
