...
var $author$project$PhoneNumber$clearPhoneNumber = function (phoneNumber) {
	var clearedNumber = A2($elm$core$String$filter, $elm$core$Char$isDigit, phoneNumber);
	var hasContryCode = ($elm$core$String$length(clearedNumber) === 11) && A2($elm$core$String$startsWith, '1', clearedNumber);
	return hasContryCode ? A3($elm$core$String$replace, '1', '', clearedNumber) : clearedNumber;
};
var $elm$core$String$slice = _String_slice;
var $author$project$PhoneNumber$validateCode = function (code) {
	return (!A2($elm$core$String$startsWith, '0', code)) && (!A2($elm$core$String$startsWith, '1', code));
};
var $author$project$PhoneNumber$validateCodes = function (clearedPhoneNumber) {
	var exchangeCode = A3($elm$core$String$slice, 3, 5, clearedPhoneNumber);
	var areaCode = A3($elm$core$String$slice, 0, 2, clearedPhoneNumber);
	return $author$project$PhoneNumber$validateCode(exchangeCode) && $author$project$PhoneNumber$validateCode(areaCode);
};
var $author$project$PhoneNumber$validateNumber = function (clearedNumber) {
	return (($elm$core$String$length(clearedNumber) === 10) && $author$project$PhoneNumber$validateCodes(clearedNumber)) ? $elm$core$Maybe$Just(clearedNumber) : $elm$core$Maybe$Nothing;
};
var $author$project$PhoneNumber$getNumber = function (phoneNumber) {
	return $author$project$PhoneNumber$validateNumber(
		$author$project$PhoneNumber$clearPhoneNumber(phoneNumber));
};
		...
		[
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('523-abc-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v9) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$elm$core$Maybe$Nothing,
					$author$project$PhoneNumber$getNumber('523-@:!-7890'));
			}),
			A2(
			$elm_explorations$test$Test$test,
...
var pipeFilename = "/tmp/elm_test-586148.sock";
var net = require('net'),
